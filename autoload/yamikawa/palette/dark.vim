function! yamikawa#palette#dark#create() abort
  let hue_base    = 282
  ...
  let g.red    = pgmnt#color#hsl(hue_red,    0.77, 0.78)
  let g.orange = pgmnt#color#hsl(hue_orange, 0.77, 0.78)
  let g.green  = pgmnt#color#hsl(hue_green,  0.77, 0.78)
  let g.lblue  = pgmnt#color#hsl(hue_lblue,  0.77, 0.78)
  let g.blue   = pgmnt#color#hsl(hue_blue,   0.77, 0.78)
  let g.pale   = pgmnt#color#hsl(hue_pale,   0.77, 0.78)
  let g.purple = pgmnt#color#hsl(hue_purple, 0.77, 0.78)
  ...
  let g.linenr_bg = pgmnt#color#adjust_color(g.normal_bg, {'saturation': +0.05, 'lightness': +0.05})
  let g.linenr_fg = pgmnt#color#lighten(g.linenr_bg, 0.20)
  let g.cursorlinenr_bg = pgmnt#color#adjust_color(g.linenr_bg, {'saturation': +0.10, 'lightness': +0.10})
  let g.cursorlinenr_fg = pgmnt#color#adjust_color(g.linenr_fg, {'saturation': +0.10, 'lightness': +0.50})
  ...
  let g.specialkey_fg = pgmnt#color#adjust_color(g.normal_bg, {'saturation': +0.10, 'lightness': +0.35})
