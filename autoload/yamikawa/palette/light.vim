function! yamikawa#palette#light#create() abort
  let hue_base    = 318
  ...
  let g.red    = pgmnt#color#hsl(hue_red,    0.70, 0.51)
  let g.orange = pgmnt#color#hsl(hue_orange, 0.70, 0.51)
  let g.green  = pgmnt#color#hsl(hue_green,  0.70, 0.51)
  let g.lblue  = pgmnt#color#hsl(hue_lblue,  0.70, 0.51)
  let g.blue   = pgmnt#color#hsl(hue_blue,   0.70, 0.51)
  let g.pale   = pgmnt#color#hsl(hue_pale,   0.70, 0.51)
  let g.purple = pgmnt#color#hsl(hue_purple, 0.70, 0.51)

  let g.normal_bg = pgmnt#color#hsl(hue_base, 0.50, 0.92)
  let g.normal_fg = pgmnt#color#hsl(hue_base, 0.00, 0.29)
  ...
  let g.linenr_bg = pgmnt#color#adjust_color(g.normal_bg, {'saturation': +0.10, 'lightness': -0.03})
  let g.linenr_fg = pgmnt#color#darken(g.linenr_bg, 0.20)
  let g.cursorlinenr_bg = pgmnt#color#adjust_color(g.linenr_bg, {'saturation': +0.05, 'lightness': -0.05})
  let g.cursorlinenr_fg = pgmnt#color#adjust_color(g.linenr_fg, {'saturation': +0.10, 'lightness': -0.20,})
  ...
  let g.pmenusel_bg = pgmnt#color#adjust_color(g.pmenu_bg, {'saturation': +0.05, 'lightness': -0.1})
  ...
  let g.folded_fg = pgmnt#color#adjust_color(g.folded_bg, {'saturation': -0.05, 'lightness': -0.35})
  ...
  let g.specialkey_fg = pgmnt#color#adjust_color(g.normal_bg, {'saturation': +0.25, 'lightness': -0.18})
  ...
  let g.visual_bg = pgmnt#color#adjust_color(g.normal_bg, {'saturation': +0.05, 'lightness': -0.10})
  let g.whitespace_fg = pgmnt#color#adjust_color(g.normal_bg, {'saturation': +0.08, 'lightness': -0.09})
